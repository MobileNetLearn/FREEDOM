...
CMD="docker run -t -d -v /boot/logs:/logs -v /etc/resolv.conf:/etc/resolv.conf -v /sys/fs/cgroup:/sys/fs/cgroup -v /boot/config:/config --privileged --net=host test_priv"
